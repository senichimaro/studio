                        ...
                        <nav className="navbar navbar-expand-lg">
                            ...
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul id="nav" className="navbar-nav ml-auto">
                                    ...
                                    <li className="nav-item">
                                        <Link className="page-scroll" to="#project">Projects</Link>
                                    </li>
                                    <li className="nav-item">
                            ...
                            <div className="navbar-btn ml-20 d-none d-sm-block">
                                <Link className="main-btn" to="#"><i className="lni-phone"></i> +98 222 4444</Link>
                            </div>
                        </nav>
                ...
                <div className="row">
                    <div className="col-xl-8 col-lg-9 col-sm-10">
                        <div className="banner-content">
                            ...
                            <Link className="banner-contact mt-25 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="2.3s" to="#contact">Get a Free Quote</Link>
                        </div>
                    </div>
                </div>
            </div>
